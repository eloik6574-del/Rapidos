...
$req_en_cours = "SELECT c.course_id, c.point_depart, c.point_arrivee, c.date_heure,
...
<title>RAPIDO - Traiter une Course</title>
...
<div class="container mt-5 pt-5">
    <h4 class="pt-3 mb-3 text-primary fw-bold">Traiter une Course</h4>
                ...
                <select class="form-select" name="course_id" required>
                    ...
                    <?php while ($course = mysqli_fetch_assoc($res_en_cours)): ?>
                        <option value="<?php echo $course['course_id']; ?>">
                            ...
                            Chauffeur: <?php echo htmlspecialchars($course['chauffeur']); ?>
                        </option>
                    <?php endwhile; ?>
                </select>
            </div>

            <button type="submit" class="btn btn-success" name="submit">Marquer comme Terminé</button>
        </form>
    <?php else: ?>
